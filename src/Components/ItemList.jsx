    ...
    <div>
      {items.map((item) => (
        <div
          ...
          className="flex justify-between items-start gap-4 border-b border-gray-200 pb-4 mb-4"
        >
          <div className="w-10/12">
            <div className="font-bold border-b-2 py-2 m-2  text-left w-6/12">
          ...
          <div className="w-2/12">
            ...
            <div className="absolute mx-12 my-[-18px]">
